...
namespace UNDAI.MODELS.MASTER
{
    public class ConnectionMaster
    {
        ...
        public async void ConnectClick(MainPageMasterViewModel mainPageMasterViewModel, int Identifier)
        {
            ...
            serverIP = IPAddress.Parse(currentServerIP);
            iPEndPoint = new IPEndPoint(serverIP, serverPort);
            app._systemSettingMasterViewModel.UndaiIPAddress = currentServerIP;
        ...
        public async Task ConnectionCheck()
        {
            ...
            {
                if (_mainPageMasterViewModel.MainPageMasterModel.messageReceivedCount > 0)
                {
                    int tempRandomNum = _mainPageMasterViewModel.MainPageMasterModel.randomNumber;
