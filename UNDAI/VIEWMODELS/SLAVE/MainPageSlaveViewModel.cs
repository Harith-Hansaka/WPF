    ...
    public class MainPageSlaveViewModel : ViewModelBase
    {
        ...
        public string SlaveIPAddressTxt
        {
            ...
            set
            {
                ...
                {
                    slaveIPAddressTxt = _stationDBPageSlaveViewModel.SlaveAntennaIPAddress;
                }
                else
                {
                    slaveIPAddressTxt = "";
        ...
        public string MasterIPAddressTxt
        {
            ...
            set
            {
                ...
                {
                    masterIPAddressTxt = _baseStationRegistrationSlaveViewModel.MasterAntennaIPAddress;
                }
                else
                {
                    masterIPAddressTxt = "";
        ...
        public MainPageSlaveCommands MainPageSlaveCommands;
        ...
        public StationDBPageSlaveViewModel _stationDBPageSlaveViewModel;
        public AlarmHistorySlaveViewModel _alarmHistorySlaveViewModel;
        public BaseStationRegistrationSlaveViewModel _baseStationRegistrationSlaveViewModel;
        ...
        (
            ...
            StationDBPageSlaveViewModel stationDBPageSlaveViewModel,
            AlarmHistorySlaveViewModel alarmHistorySlaveViewModel,
            BaseStationRegistrationSlaveViewModel baseStationRegistrationSlaveViewModel,
            SystemResetSettingSlaveViewModel resetSettingSlaveViewModel,
            NavigationService selfRegSlaveCommandNavigationService, 
            NavigationService stationDBSlaveCommandNavigationService, 
            NavigationService masterPageNavigationService,
            NavigationService systemSettingSlaveNavigationService,
            NavigationService baseStationRegistrationSlaveCommand,
            NavigationService systemResetSettingSlaveNavigationService
        ...
        ) 
        {
            ...
            MainPageSlaveModel = new MainPageSlaveModel(this, connectionSlave);
            ConnectCommandMouseDownCommand = new ExecutionConnectionSlaveCommand(this, connectionSlave, 1);
            ConnectCommandMouseUpCommand = new ExecutionConnectionSlaveCommand(this, connectionSlave,2);
            MainPageSlaveCommands = new MainPageSlaveCommands(this,connectionSlave, MainPageSlaveModel, 0);
            BtnUpArrowMainPageMouseDownCommand = new UpDownMouseRelaySlaveCommand(this, 1);
            BtnUpArrowMainPageMouseUpCommand = new UpDownMouseRelaySlaveCommand(this, 2);
            BtnDownArrowMainPageMouseDownCommand = new UpDownMouseRelaySlaveCommand(this, 3);
            BtnDownArrowMainPageMouseUpCommand = new UpDownMouseRelaySlaveCommand(this, 4);
            BtnCCWMainPageMouseDownCommand = new UpDownMouseRelaySlaveCommand(this, 5);
            BtnCCWMainPageMouseUpCommand = new UpDownMouseRelaySlaveCommand(this, 6);
            BtnCWMainPageMouseDownCommand = new UpDownMouseRelaySlaveCommand(this, 7);
            BtnCWMainPageMouseUpCommand = new UpDownMouseRelaySlaveCommand(this, 8);
            HighSpeedBtnSlaveCommand = new UpDownMouseRelaySlaveCommand(this, 9);
            LowSpeedBtnSlaveCommand = new UpDownMouseRelaySlaveCommand(this, 10);
            InchingSpeedBtnSlaveCommand = new UpDownMouseRelaySlaveCommand(this, 11);
            ElevationAngleSetSlaveCommand = new UpDownMouseRelaySlaveCommand(this, 12);
            AzimuthAngleSetSlaveCommand = new UpDownMouseRelaySlaveCommand(this, 13);
            SaveAngleMainPageSlaveCommand = new UpDownMouseRelaySlaveCommand(this, 14);
            LoadLoadAngleMainPageSlaveCommand = new UpDownMouseRelaySlaveCommand(this, 15);
            UnitMainSlaveCommand = new UpDownMouseRelaySlaveCommand(this, 16);
            StopCommand = new UpDownMouseRelaySlaveCommand(this, 17);
            HomePositionDownCommand = new UpDownMouseRelaySlaveCommand(this, 18);
            HomePositionUpCommand = new UpDownMouseRelaySlaveCommand(this, 19);
            PeakSearchDownCommand = new UpDownMouseRelaySlaveCommand(this, 20);
            PeakSearchUpCommand = new UpDownMouseRelaySlaveCommand(this, 21);
            DirectionSearchDownCommand = new UpDownMouseRelaySlaveCommand(this, 22);
            DirectionSearchUPCommand = new UpDownMouseRelaySlaveCommand(this, 23);
            _elevationCalculationModel = new ElevationCalculationModel();

            // Navigation
            ToMasterCommand = new NavigateCommand(masterPageNavigationService);
            SelfRegSlaveCommand = new NavigateCommand(selfRegSlaveCommandNavigationService);
            StationDBSlaveCommand = new NavigateCommand(stationDBSlaveCommandNavigationService);
            BaseStationRegistrationSlaveCommand = new NavigateCommand(baseStationRegistrationSlaveCommand);
            SystemSettingSlavePage = new NavigateCommand(systemSettingSlaveNavigationService);
            SystemResetSettingSlavePage = new NavigateCommand(systemResetSettingSlaveNavigationService);
