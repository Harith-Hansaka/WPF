...
namespace UNDAI.VIEWMODELS.SLAVE
{
    public class SystemSettingSlaveViewModel : ViewModelBase
    {
        ...
        (
            ...
            NavigationService alarmHistorySlaveNavigationService
        )
        {
            ...
            AlarmHistorySlaveNavigateCommand        = new NavigateCommand(alarmHistorySlaveNavigationService);
            BtnUpArrowMainPageMouseDownCommand      = new UpDownMouseRelaySlaveSystemSettingCommand(this, 1);
            BtnUpArrowMainPageMouseUpCommand        = new UpDownMouseRelaySlaveSystemSettingCommand(this, 2);
            BtnDownArrowMainPageMouseDownCommand    = new UpDownMouseRelaySlaveSystemSettingCommand(this, 3);
            BtnDownArrowMainPageMouseUpCommand      = new UpDownMouseRelaySlaveSystemSettingCommand(this, 4);
            BtnCCWMainPageMouseDownCommand          = new UpDownMouseRelaySlaveSystemSettingCommand(this, 5);
            BtnCCWMainPageMouseUpCommand            = new UpDownMouseRelaySlaveSystemSettingCommand(this, 6);
            BtnCWMainPageMouseDownCommand           = new UpDownMouseRelaySlaveSystemSettingCommand(this, 7);
            BtnCWMainPageMouseUpCommand             = new UpDownMouseRelaySlaveSystemSettingCommand(this, 8);
            ElevationEncorderResetCommand           = new UpDownMouseRelaySlaveSystemSettingCommand(this, 9);
            AzimuthEncorderResetCommand             = new UpDownMouseRelaySlaveSystemSettingCommand(this, 10);
            SystemSettingRegister                   = new UpDownMouseRelaySlaveSystemSettingCommand(this, 11);
            ContinuousOperationTimeCommand          = new UpDownMouseRelaySlaveSystemSettingCommand(this, 12);
            ContinuousOperationTimerStopCommand     = new UpDownMouseRelaySlaveSystemSettingCommand(this, 13);
            AlarmResetCommand                       = new UpDownMouseRelaySlaveSystemSettingCommand(this, 14);
        ...
        public int SelectedMode
        {
            ...
            set
            {
                ...
                _systemSettingSlaveModel.MasterSelectedColor();
                _systemSettingSlaveModel.SlaveSelectedColor();
