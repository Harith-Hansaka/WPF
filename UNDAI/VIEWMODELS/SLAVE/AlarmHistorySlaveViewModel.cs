...
namespace UNDAI.VIEWMODELS.SLAVE
{
    public class AlarmHistorySlaveViewModel : ViewModelBase
    {
        ...
        public AlarmHistorySlaveViewModel(NavigationService mainPageNavigationService, NavigationService systemSettingSlaveNavigationService) 
        {
            MainPageSlaveNavigateCommand = new NavigateCommand(mainPageNavigationService);
            SystemSettingSlaveNavigateCommand = new NavigateCommand(systemSettingSlaveNavigationService);

            AlarmHistorySlaveModel = new ObservableCollection<AlarmHistorySlaveModel>();
            DeleteSelectedItemCommand = new UpDownMouseRelaySlaveAlarmHistoryCommand(this, 1);
            AlarmHistoryExportCommand = new UpDownMouseRelaySlaveAlarmHistoryCommand(this, 2);
