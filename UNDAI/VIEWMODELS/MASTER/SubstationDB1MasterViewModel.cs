...
namespace UNDAI.VIEWMODELS.MASTER
{
    public class SubstationDB1MasterViewModel : ViewModelBase
    {
        ...
        (
            ...
            NavigationService substationRegistrationMasterNavigateService
        )
        {
            MainPageMasterNavigateCommand = new NavigateCommand(mainPageNavigationService);
            SubstationRegistrationMasterNavigateCommand = new NavigateCommand(substationRegistrationMasterNavigateService);

            SubstationDB1MasterModel = new ObservableCollection<SubstationDB1MasterModel>();
            DeleteSelectedItemCommand = new UpDownMouseRelayMasterSubstationDB1Command(this, 1);
            DBExportCommand = new UpDownMouseRelayMasterSubstationDB1Command(this, 2);
            EditDataGridCommand = new UpDownMouseRelayMasterSubstationDB1Command(this, 3);
            RegistrationDataGridCommand = new UpDownMouseRelayMasterSubstationDB1Command(this, 4);
        ...
        public void ExportStationDBPageModelMasterToCsv(ObservableCollection<SubstationDB1MasterModel> substationDB1MasterModel)
        {
            // Specify the file path for the CSV output
            string baseDirectory = AppContext.BaseDirectory;
