...
namespace UNDAI.VIEWMODELS.MASTER
{
    public class SubstationDB3MasterViewModel : ViewModelBase
    {
        ...
        )
        {
            ...
            DeleteSelectedItemCommand = new UpDownMouseRelayMasterSubstationDB3Command(this, 1);
            DBExportCommand = new UpDownMouseRelayMasterSubstationDB3Command(this, 2);
            EditDataGridCommand = new UpDownMouseRelayMasterSubstationDB3Command(this, 3);
            RegistrationDataGridCommand = new UpDownMouseRelayMasterSubstationDB3Command(this, 4);
        ...
        public void ExportStationDBPageModelMasterToCsv(ObservableCollection<SubstationDB3MasterModel> substationDB3MasterModel)
        {
            // Specify the file path for the CSV output
            string baseDirectory = AppContext.BaseDirectory;
