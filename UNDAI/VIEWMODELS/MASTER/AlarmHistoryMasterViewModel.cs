...
namespace UNDAI.VIEWMODELS.MASTER
{
    public class AlarmHistoryMasterViewModel : ViewModelBase
    {
        ...
        public AlarmHistoryMasterViewModel(NavigationService mainPageNavigationService, NavigationService systemSettingMasterNavigationService) 
        {
            MainPageMasterNavigateCommand = new NavigateCommand(mainPageNavigationService);
            SystemSettingMasterNavigateCommand = new NavigateCommand(systemSettingMasterNavigationService);

            AlarmHistoryMasterModel = new ObservableCollection<AlarmHistoryMasterModel>();
            DeleteSelectedItemCommand = new UpDownMouseRelayMasterAlarmHistoryCommand(this, 1);
            AlarmHistoryExportCommand = new UpDownMouseRelayMasterAlarmHistoryCommand(this, 2);
