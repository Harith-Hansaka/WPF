...
namespace UNDAI.VIEWMODELS.MASTER
{
    public class SubstationDB4MasterViewModel : ViewModelBase
    {
        ...
        )
        {
            ...
            DeleteSelectedItemCommand = new UpDownMouseRelayMasterSubstationDB4Command(this, 1);
            DBExportCommand = new UpDownMouseRelayMasterSubstationDB4Command(this, 2);
            EditDataGridCommand = new UpDownMouseRelayMasterSubstationDB4Command(this, 3);
            RegistrationDataGridCommand = new UpDownMouseRelayMasterSubstationDB4Command(this, 4);
        ...
        public void ExportStationDBPageModelMasterToCsv(ObservableCollection<SubstationDB4MasterModel> substationDB4MasterModel)
        {
            // Specify the file path for the CSV output
            string baseDirectory = AppContext.BaseDirectory;
