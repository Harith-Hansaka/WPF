...
namespace UNDAI.VIEWMODELS.MASTER
{
    public class MainPageMasterViewModel : ViewModelBase
    {
        ...
        public string ControllerAccess
        {
            get
            {
                if (Connected == "CONNECT" || _connectionMaster.loadingImg)
                {
        ...
        public string LoadingScreenImgVisibility
        {
            get
            {
                if (_connectionMaster.loadingImg && Connected != "CONNECT")
                {
        ...
        public string MasterAlarmData
        {
            ...
            set
            {
                ...
                if(masterAlarmData != "")
                {
                    _alarmHistoryMasterViewModel.AddAlarmHistory(DateTime.Now.Date.ToString("yyyy-MM-dd"), DateTime.Now.TimeOfDay.ToString(@"hh\:mm\:ss"), masterAlarmData);
                }
        ...
        public MainPageMasterCommands MainPageMasterCommands;
        public MainPageMasterModel MainPageMasterModel;
        ...
        public StationDBPageMasterViewModel _stationDBPageMasterViewModel;
        public SubstationRegistrationMasterViewModel _substationRegistrationMasterViewModel;
        ...
        public SystemSettingAccessPIN systemSettingAccessPIN;
        ...
        public ICommand SubstationRegistrationMasterCommand { get; }
        ...
        ICommand SystemResetSettingMasterPage {  get; }
        ...
        //Keyboard
        public ICommand ShowNumericKeyboardCommand { get; }
        ...
        (
            ...
            StationDBPageMasterViewModel stationDBPageMasterViewModel,
            ...
            NavigationService selfRegMasterCommand, 
            NavigationService stationDBMasterCommand, 
            NavigationService slavePageNavigationService,
            NavigationService systemSettingMasterNavigationService,
            ...
            NavigationService substationRegistrationNavigationService,
            NavigationService systemResetSettingMasterNavigationService
        )
        {
            ...
            ConnectCommandMouseDownCommand = new ExecutionConnectionMasterCommand(this, connectionMaster,1);
            ConnectCommandMouseUpCommand = new ExecutionConnectionMasterCommand(this, connectionMaster,2);
            MainPageMasterModel = new MainPageMasterModel(this, connectionMaster);
            MainPageMasterCommands = new MainPageMasterCommands(this,connectionMaster, MainPageMasterModel, 0);
            BtnUpArrowMainPageMouseDownCommand = new UpDownMouseRelayMasterCommand(this, 1);
            BtnUpArrowMainPageMouseUpCommand = new UpDownMouseRelayMasterCommand(this, 2);
            BtnDownArrowMainPageMouseDownCommand = new UpDownMouseRelayMasterCommand(this, 3);
            BtnDownArrowMainPageMouseUpCommand = new UpDownMouseRelayMasterCommand(this, 4);
            BtnCCWMainPageMouseDownCommand = new UpDownMouseRelayMasterCommand(this, 5);
            BtnCCWMainPageMouseUpCommand = new UpDownMouseRelayMasterCommand(this, 6);
            BtnCWMainPageMouseDownCommand = new UpDownMouseRelayMasterCommand(this, 7);
            BtnCWMainPageMouseUpCommand = new UpDownMouseRelayMasterCommand(this, 8);
            HighSpeedBtnMasterCommand = new UpDownMouseRelayMasterCommand(this, 9);
            LowSpeedBtnMasterCommand = new UpDownMouseRelayMasterCommand(this, 10);
            InchingSpeedBtnMasterCommand = new UpDownMouseRelayMasterCommand(this, 11);
            ElevationAngleSetMasterCommand = new UpDownMouseRelayMasterCommand(this, 12);
            AzimuthAngleSetMasterCommand = new UpDownMouseRelayMasterCommand(this, 13);
            SaveAngleMainPageMasterCommand = new UpDownMouseRelayMasterCommand(this, 14);
            LoadLoadAngleMainPageMasterCommand = new UpDownMouseRelayMasterCommand(this, 15);
            UnitMainMasterCommand = new UpDownMouseRelayMasterCommand(this, 16);
            StopCommand = new UpDownMouseRelayMasterCommand(this, 17);
            HomePositionDownCommand = new UpDownMouseRelayMasterCommand(this, 18);
            HomePositionUpCommand = new UpDownMouseRelayMasterCommand(this, 19);
            PeakSearchDownCommand = new UpDownMouseRelayMasterCommand(this, 20);
            PeakSearchUpCommand = new UpDownMouseRelayMasterCommand(this, 21);
            DirectionSearchDownCommand = new UpDownMouseRelayMasterCommand(this, 22);
            DirectionSearchUPCommand = new UpDownMouseRelayMasterCommand(this, 23);
            _elevationCalculationModel = new ElevationCalculationModel();

            //Keyboard
            ShowNumericKeyboardCommand = new UpDownMouseRelayMasterCommand(this, 22);

            // Navigation
            ToSlaveCommand = new NavigateCommand(slavePageNavigationService);
            SelfRegMasterCommand = new NavigateCommand(selfRegMasterCommand);
            StationDBMasterCommand = new NavigateCommand(stationDBMasterCommand);
            SubstationDB1MasterCommand = new NavigateCommand(substationDB1MasterNavigationService);
            SubstationDB2MasterCommand = new NavigateCommand(substationDB2MasterNavigationService);
            SubstationDB3MasterCommand = new NavigateCommand(substationDB3MasterNavigationService);
            SubstationDB4MasterCommand = new NavigateCommand(substationDB4MasterNavigationService);
            SubstationRegistrationMasterCommand = new NavigateCommand(substationRegistrationNavigationService);
            SystemSettingMasterPage = new NavigateCommand(systemSettingMasterNavigationService);
            SystemResetSettingMasterPage = new NavigateCommand(systemResetSettingMasterNavigationService);
        ...
        private async void MethodChange()
        {
            ...
            catch
            {
                ...
                try
                {
                    ...
                    {
                        writer.WriteLine("1,169.254.1.110");
                    }
                    if (_systemSettingSlaveViewModel == null || _systemSettingMasterViewModel == null)
                    {
                        // Access properties directly
                ...
                catch (Exception ex)
                {
                    ...
                    MasterAlarmData = $"Error saving Seleced method address: {ex.Message}";
                }
            }
