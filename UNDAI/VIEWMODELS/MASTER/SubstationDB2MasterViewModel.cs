...
namespace UNDAI.VIEWMODELS.MASTER
{
    public class SubstationDB2MasterViewModel : ViewModelBase
    {
        ...
        )
        {
            ...
            DeleteSelectedItemCommand = new UpDownMouseRelayMasterSubstationDB2Command(this, 1);
            DBExportCommand = new UpDownMouseRelayMasterSubstationDB2Command(this, 2);
            EditDataGridCommand = new UpDownMouseRelayMasterSubstationDB2Command(this, 3);
            RegistrationDataGridCommand = new UpDownMouseRelayMasterSubstationDB2Command(this, 4);
        ...
        public void ExportStationDBPageModelMasterToCsv(ObservableCollection<SubstationDB2MasterModel> substationDB2MasterModel)
        {
            // Specify the file path for the CSV output
            string baseDirectory = AppContext.BaseDirectory;
